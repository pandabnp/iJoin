<template lang="pug">
  v-navigation-drawer.my-sidebar(
    ...
    v-layout(justify-center wrap)
      // img.my-sidebar__backdrop(src='~/@/assets/images/backdrop.jpg' alt='Vue ijoin')
    ...
    v-list(dark)
      ...
      v-list-tile(ripple :to="{ name: 'notification' }")
        v-list-tile-action
          v-icon library_books
        v-list-tile-content
          v-list-tile-title Notification
      ...
      v-list-group(prepend-icon='assessment')
        ...
        v-list-tile(ripple :to="{ name: 'report' }")
          v-list-tile-content
            v-list-tile-title My Assessment Report
